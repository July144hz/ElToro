    ...
    def verificar(var1,var2):
        ...
        if fcursor.fetchall():
            ...
            def imonto():
                ...
                btn5=Button(text="INGRESAR",image=ingresar,font=("bahnschrift",20),bg=fondo,activebackground=fondo,padx=75,borderwidth=0,highlightthickness=0,highlightcolor=fondo,command=lambda:(l8.configure(text=f"Saldo actual:{saldo+20}"),ingreso(monto)))
                btn5.pack()
                btn7 = Button(text="SALIR",image=salir,font=("bahnschrift",20),bg=fondo,activebackground=fondo,padx=75,borderwidth=0,highlightthickness=0,highlightcolor=fondo,command=lambda:(volverprincipal()))
                btn7.pack()
            ...
            def rmonto():
                ...
                e4.pack()
                btn6 = Button(text="RETIRAR",image=retirar, font=("bahnschrift",20),bg=fondo,activebackground=fondo,padx=75,borderwidth=0,highlightthickness=0,highlightcolor=fondo, command=lambda:(retiro(monto)))
                btn6.pack()
                btn8 = Button(text="SALIR",image=salir,font=("bahnschrift",20),bg=fondo,activebackground=fondo,padx=75,borderwidth=0,highlightthickness=0,highlightcolor=fondo,command=lambda:(volverprincipal2()))
                btn8.pack()
